...
skills = [ (_,) for _ in (['Python', 'SQL', 'API', 'Telegram', 'AI'])]
...
if __name__ == '__main__':
    ...
    #manager.insert_project([(8475201121, "PokemonsGO", "https://github.com/ssgroove1/PokemonsAPI.git", 4)])
    #manager.insert_skill(8475201121, "PokemonsGO", "Telegram")
    #manager.update_projects("description", ("Телеграмм бот, облегчающий работу админам группам. Может следить за тем чтобы в чат группы не кидали подозрительных ссылок, мутить и банить пользователей, нарушающих правила сервера.", "ManagerChatBot", 8475201121))

    print(manager.get_projects(8475201121))
    print('')
    print(manager.get_project_info(8475201121, "PokemonsGO"))
    print('')
